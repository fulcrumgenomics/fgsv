...
case class AggregatedBreakpointPileup(id: String,
   ...
   * @param targets Optional map of contig to set of target intervals. If not provided, target overlap fields are set to
   *                false.
   */
...
/** Thin wrapper around a Seq[Int] primarily used to convert back and forth from a string representation */
