 ...
 * @param left_min_pos          Minimum coordinate of left breakends (1-based inclusive)
 * @param left_max_pos          Maximum coordinate of left breakends (1-based inclusive)
 * @param left_strand           Strand at left breakends
 * @param right_contig          Contig name for right side of breakpoint
 * @param right_min_pos         Minimum coordinate of right breakends (1-based inclusive)
 * @param right_max_pos         Maximum coordinate of right breakends (1-based inclusive)
